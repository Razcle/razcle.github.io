...
who I think may have heard it from [Matthew Johnson](). Jamie and Matthew are both contributors/authors of the Python [autograd](https://github.com/HIPS/autograd) package
